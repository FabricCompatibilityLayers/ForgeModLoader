...
public abstract class Entity {
        ...
        if (this.handleWaterMovement()) {
            if (!this.inWater && !this.firstUpdate) {
                ...
                for(int var9 = 0; (float)var9 < 1.0F + this.width * 20.0F; ++var9) {
                    ...
                    this.worldObj
                        .spawnParticle(
                            "splash", this.posX + (double)var11, (double)(var7 + 1.0F), this.posZ + (double)var12, this.motionX, this.motionY, this.motionZ
                        );
                }
            }
    ...
    public void moveEntity(double d, double e, double par5) {
        if (this.noClip) {
            ...
            for(int var20 = 0; var20 < var36.size(); ++var20) {
                e = ((AxisAlignedBB)var36.get(var20)).calculateYOffset(this.boundingBox, e);
            }

            this.boundingBox.offset(0.0, e, 0.0);
            if (!this.field_9077_F && var13 != e) {
                par5 = 0.0;
                e = 0.0;
                d = 0.0;
            }
            ...
            for(int var21 = 0; var21 < var36.size(); ++var21) {
                d = ((AxisAlignedBB)var36.get(var21)).calculateXOffset(this.boundingBox, d);
            }

            this.boundingBox.offset(d, 0.0, 0.0);
            if (!this.field_9077_F && var11 != d) {
                par5 = 0.0;
                e = 0.0;
                d = 0.0;
            }
            ...
            for(int var39 = 0; var39 < var36.size(); ++var39) {
                par5 = ((AxisAlignedBB)var36.get(var39)).calculateZOffset(this.boundingBox, par5);
            }
            ...
            if (this.stepHeight > 0.0F && var38 && (var18 || this.ySize < 0.05F) && (var11 != d || var15 != par5)) {
                ...
                for(int var28 = 0; var28 < var36.size(); ++var28) {
                    e = ((AxisAlignedBB)var36.get(var28)).calculateYOffset(this.boundingBox, e);
                }
                ...
                for(int var48 = 0; var48 < var36.size(); ++var48) {
                    d = ((AxisAlignedBB)var36.get(var48)).calculateXOffset(this.boundingBox, d);
                }
                ...
                for(int var49 = 0; var49 < var36.size(); ++var49) {
                    par5 = ((AxisAlignedBB)var36.get(var49)).calculateZOffset(this.boundingBox, par5);
                }
                ...
                if (!this.field_9077_F && var13 != e) {
                    ...
                    for(int var50 = 0; var50 < var36.size(); ++var50) {
                        e = ((AxisAlignedBB)var36.get(var50)).calculateYOffset(this.boundingBox, e);
                    }
    ...
    public void setPositionAndRotation(double d, double e, double f, float g, float par8) {
        ...
        this.ySize = 0.0F;
        double var9 = (double)(this.prevRotationYaw - g);
        if (var9 < -180.0) {

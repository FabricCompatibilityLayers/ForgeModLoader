...
public abstract class GuiScrollingList {
    ...
    public void drawScreen(int mouseX, int mouseY, float p_22243_3_) {
        ...
        var18.addVertexWithUV(this.left, this.bottom, 0.0D, (float) this.left / var17, (float) (this.bottom + (int) this.scrollDistance) / var17);
        var18.addVertexWithUV(this.right, this.bottom, 0.0D, (float) this.right / var17, (float) (this.bottom + (int) this.scrollDistance) / var17);
        var18.addVertexWithUV(this.right, this.top, 0.0D, (float) this.right / var17, (float) (this.top + (int) this.scrollDistance) / var17);
        var18.addVertexWithUV(this.left, this.top, 0.0D, (float) this.left / var17, (float) (this.top + (int) this.scrollDistance) / var17);
        var18.draw();
//        boxRight = this.listWidth / 2 - 92 - 16;
    ...
    private void overlayBackground(int p_22239_1_, int p_22239_2_, int p_22239_3_, int p_22239_4_) {
        ...
        var5.addVertexWithUV(0.0D, p_22239_2_, 0.0D, 0.0D, (float) p_22239_2_ / var6);
        var5.addVertexWithUV(this.listWidth, p_22239_2_, 0.0D, (float) this.listWidth / var6, (float) p_22239_2_ / var6);
        var5.setColorRGBA_I(4210752, p_22239_3_);
        var5.addVertexWithUV(this.listWidth, p_22239_1_, 0.0D, (float) this.listWidth / var6, (float) p_22239_1_ / var6);
        var5.addVertexWithUV(0.0D, p_22239_1_, 0.0D, 0.0D, (float) p_22239_1_ / var6);
        var5.draw();
    }
}

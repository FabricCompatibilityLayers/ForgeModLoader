...
public class FMLTextureFX extends TextureFX implements ITextureFX {
    ...
    public void onTextureDimensionsUpdate(int width, int height) {
        ...
        this.tileSizeSquare = tileSizeBase * tileSizeBase;
        this.tileSizeMask = tileSizeBase - 1;
        this.tileSizeSquareMask = tileSizeSquare - 1;
        this.setErrored(false);
        this.setup();
    }

    protected void setup() {
        this.imageData = new byte[tileSizeSquare << 2];
    }

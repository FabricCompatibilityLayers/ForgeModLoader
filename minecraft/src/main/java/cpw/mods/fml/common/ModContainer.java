 ...
 * <p>The philosophy is that individual mod implementation technologies should not impact the actual loading and
 * management
...
public interface ModContainer {
    ...
    /**
     * Get a list of mods to load before this one. The special value "*" indicates to load <i>after</i> all other mods
     * (except other "*" mods).
     */
    List<String> getPreDepends();

    /**
     * Get a list of mods to load after this one. The special value "*" indicates to load <i>before</i> all other mods
     * (except other "*" mods).
     */

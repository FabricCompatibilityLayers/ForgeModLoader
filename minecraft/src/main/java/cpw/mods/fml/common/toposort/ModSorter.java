...
public class ModSorter {
    private final ModContainer beforeAll = new FMLModContainer("DummyBeforeAll");
    private final ModContainer afterAll = new FMLModContainer("DummyAfterAll");
    private final ModContainer before = new FMLModContainer("DummyBefore");
    private final ModContainer after = new FMLModContainer("DummyAfter");
